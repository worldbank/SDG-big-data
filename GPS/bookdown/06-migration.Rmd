...
Here we reduce our user sample \@ref(selection) to only active users who had a home location in the city at any given
time. It's important to note that although we use the term _city_ we are using the whole extent of their metropolitan
area.
...
Finally we compute the cummulative percentage change of the difference between the individuals going to rural areas and
