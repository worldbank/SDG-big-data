...
We then labelled these sampled tweets, which allowed us to get an estimate of the precision of the classifiers (see figure XXX).

**ADD FIGURE with ranks x-axis and percentage of positives y-axis**
