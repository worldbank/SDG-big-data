...
\hypersetup{
  pdftitle={GPS Analytics},
  pdfauthor={GPS Analytics Group},
  hidelinks,
...
are used for much more than Pier to Pier (P2P) transactions and it's global penetration is estimated to be almost 50\%.
...
\NormalTok{  x }\OperatorTok{=}\NormalTok{ x}\OperatorTok{+}\NormalTok{x}
...
{\centering \includegraphics[width=0.8\linewidth]{gps-mobility_files/figure-latex/nice-fig-1} 
